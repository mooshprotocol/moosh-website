  ...
  return (
    <section className="bg-moosh-black-light section-padding relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-1/2 h-px bg-gradient-to-r from-transparent via-moosh-green/30 to-transparent"></div>
        <div className="absolute bottom-0 right-1/4 w-1/2 h-px bg-gradient-to-l from-transparent via-moosh-green/30 to-transparent"></div>
        <div className="absolute top-1/3 left-0 w-1/3 h-px bg-gradient-to-r from-transparent via-moosh-green/20 to-transparent"></div>
        <div className="absolute bottom-1/3 right-0 w-1/3 h-px bg-gradient-to-l from-transparent via-moosh-green/20 to-transparent"></div>
      </div>
      
      {/* Green accent dots */}
      <div className="green-dot-pattern">
        <div className="dot" style={{ top: '10%', left: '10%', width: '2px', height: '2px', animationDelay: '0s' }}></div>
        <div className="dot" style={{ bottom: '15%', right: '12%', width: '3px', height: '3px', animationDelay: '1s' }}></div>
        <div className="dot" style={{ top: '70%', left: '8%', width: '2px', height: '2px', animationDelay: '2s' }}></div>
        <div className="dot" style={{ top: '50%', right: '8%', width: '3px', height: '3px', animationDelay: '0.5s' }}></div>
      </div>
            ...
            return (
              ...
              >
                <div className={`text-center p-8 bg-moosh-black-card rounded-2xl border border-moosh-black-lighter hover:scale-[1.02] transition-all duration-300 ${colorClasses.glow} ${colorClasses.border}`}>
                  ...
                  <h3 className="text-lg font-semibold text-moosh-text-primary mb-4 group-hover:text-moosh-green transition-colors duration-300">
                    {position.title}
                  </h3>
