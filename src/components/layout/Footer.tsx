...
export default function Footer() {
  return (
    <footer className="bg-moosh-black border-t border-moosh-black-lighter">
      <div className="container mx-auto px-6 py-16 flex flex-col justify-end min-h-[30vh]">
        {/* Social media icons and copyright - Compact layout */}
...
function FooterCopyright() {
  return (
    <p className="text-moosh-text-muted text-xs font-orbitron font-medium tracking-wider uppercase">
